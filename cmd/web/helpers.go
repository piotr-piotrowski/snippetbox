...
// The serverError helper writes a log entry at Error level (including the request method
...
// We'll use this later in the book to send responses like 400 "Bad Request" when
